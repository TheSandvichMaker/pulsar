...
static MemberDefinition MembersOf_GameConfig[] = {
    ...
    { 0, MetaType_u8, 5, "reset", (unsigned int)&((GameConfig*)0)->reset, sizeof(u8) },
    ...
    { 0, MetaType_u8, 15, "alternate_reset", (unsigned int)&((GameConfig*)0)->alternate_reset, sizeof(u8) },
    ...
    { 0, MetaType_f32, 26, "player_self_destruct_speed", (unsigned int)&((GameConfig*)0)->player_self_destruct_speed, sizeof(f32) },
